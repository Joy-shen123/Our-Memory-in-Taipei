...
(function () {
  ...
  const SPOTS = [
    ...
    { id: 'redhouse', anchor: 'redhouse', dx: -1.4, y: 6.2, eras: ALL, far: 90,   // the octagon's front face (scene-red.js cx 16.6, circumradius 7.2)
      en: 'Ximen Red House', zh: '西門紅樓', when: '2020', tag: '2020',
      caption: 'The 1908 octagon as it stands today, in a colour-survey photograph. The swatches are the surveyors’ own record of its brick, mortar and trim.',
      by: '吳宇凡', holder: '國立臺北科技大學文化事業發展學系', licence: 'CC0', licenceUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      src: 'https://tcmb.culture.tw/zh-tw/detail?indexCode=Culture_Object&id=293372', img: 'redhouse.webp', w: 1200, h: 849 },
    ...
    { id: 'dihua', anchor: 'dihua', dx: -1.6, y: 6.8, eras: ALL, far: 90,         // the east arcade row
      en: 'Dihua Street', zh: '迪化街', when: 'c. 2020 · building from 1919', tag: 'c. 2020',
      caption: 'A Western-style shophouse front, balcony and pilasters, built in 1919 and photographed for a recent colour survey. The swatches are the surveyors’ own. This is not a period photograph.',
      by: '吳宇凡', holder: '國立臺灣歷史博物館 (survey: 國立臺北科技大學文化事業發展學系)', licence: 'CC0', licenceUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      src: 'https://tcmb.culture.tw/zh-tw/detail?indexCode=Culture_Object&id=293330', img: 'dihua.webp', w: 1200, h: 849 },
    { id: 'temple', anchor: 'chenghuang', dx: 2.6, y: 5.6, eras: ALL, far: 90,    // the hall's front at x -8.8 (scene-dadao.js xf)
      en: 'Xiahai City God Temple', zh: '霞海城隍廟', when: 'Undated', tag: 'photo',
      caption: 'The single hall at 迪化街一段61號: swallowtail ridge, red doors, the incense table on the pavement. A colour-survey photograph; the swatches are the surveyors’ own.',
      by: '吳宇凡', holder: '國立臺灣歷史博物館', licence: 'CC0', licenceUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      src: 'https://tcmb.culture.tw/zh-tw/detail?indexCode=Culture_Object&id=292346', img: 'temple.webp', w: 1200, h: 849 },
