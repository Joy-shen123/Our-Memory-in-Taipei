// meshopt_decoder.js — the EXT_meshopt_compression decoder for GLTFLoader.js (meshoptimizer 1.2.0,
// npm `meshoptimizer/meshopt_decoder.cjs`, unmodified below this header; MIT). Loaded after
// GLTFLoader.js; models.js hands it to the loader. The models in asset/models/ are packed with
// tools/pack-models.sh and need it: a packed glb without the decoder fails to load.
